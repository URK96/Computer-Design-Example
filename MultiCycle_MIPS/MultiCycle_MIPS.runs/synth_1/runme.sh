...
HD_PWD='C:/Users/chlwl/Desktop/MultiCycle_MIPS/MultiCycle_MIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MultiCycle_MIPS_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MultiCycle_MIPS_TOP.tcl
